...
def filter_csv(csv_path, bad_rings, filtered_root):
    ...
    return filtered_path, removed  # 🔥 Retourne aussi le nombre retiré
...
def create_global_filtered_csv(filtered_folder, removed_total):
    # Nom du fichier final → inclut le compteur !
...
def main():
    ...
    total_removed_rings = 0  # 🔥 compteur global
    ...
    create_global_filtered_csv(filtered_csv_folder, total_removed_rings)
